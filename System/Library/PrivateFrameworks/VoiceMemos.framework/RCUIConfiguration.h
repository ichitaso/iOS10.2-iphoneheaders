...
@property (nonatomic,retain) UIColor * waveformBackgroundColor;                        //@synthesize waveformBackgroundColor=_waveformBackgroundColor - In the implementation block
...
-(void)setWaveformBackgroundColor:(UIColor *)arg1 ;
