...
@class CATHTTPMessageParser, NSMutableArray, NSObject, NSError, NSMutableData, NSArray, NSString, CATRemoteConnectionSocketOptions, NSInputStream, NSOutputStream;
