...
@interface MiroAnalysisImageHelpers : NSObject {
	...
	SCD_Struct_Mi1 _recordingStartTime;
...
+(unsigned long long)exifOrientationForCaptureOrientation:(long long)arg1 cameraPosition:(long long)arg2 ;
-(id)init;
...
-(void)_updateFaceRangeWithFaceID:(long long)arg1 detectionTime:(SCD_Struct_Mi1)arg2 facePosition:(long long)arg3 flags:(unsigned long long)arg4 faceBounds:(CGRect)arg5 ;
...
-(BOOL)_startOutputtingFaceRangesWithStartTime:(SCD_Struct_Mi1)arg1 orientation:(unsigned long long)arg2 ;
-(id)_analyzeColorsInVideoFrame:(CGImageRef)arg1 withOrientation:(unsigned long long)arg2 ;
-(BOOL)_processOutputtingFaceRangeWithCGImage:(CGImageRef)arg1 detectionTime:(SCD_Struct_Mi1)arg2 faceRanges:(id*)arg3 ;
-(void)_stopOutputtingFaceRangesWithEndTime:(SCD_Struct_Mi1)arg1 lastFaceRanges:(id*)arg2 ;
@end
