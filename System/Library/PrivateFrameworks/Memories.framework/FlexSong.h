...
-(void)updateSongArtist:(id)arg1 title:(id)arg2 tags:(id)arg3 ;
...
-(id)analysisData;
-(id)initWithUID:(id)arg1 songName:(id)arg2 artistName:(id)arg3 sampleRate:(long long)arg4 tagIDs:(id)arg5 mainSegments:(id)arg6 crossFadeSegments:(id)arg7 assets:(id)arg8 audioFileExtension:(id)arg9 audioEncoderPresetName:(id)arg10 ;
