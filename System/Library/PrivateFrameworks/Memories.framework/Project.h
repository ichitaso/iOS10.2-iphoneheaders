...
@property (assign,getter=isMiro,nonatomic) BOOL miro;                              //@synthesize miro=_miro - In the implementation block
...
-(void)nextKenBurnsStart:(SCD_Struct_Mi17*)arg1 end:(SCD_Struct_Mi17*)arg2 ;
-(CGRect)rectFromKenBurnsPosition:(SCD_Struct_Mi17)arg1 outputAspectRatio:(float)arg2 image:(id)arg3 ;
