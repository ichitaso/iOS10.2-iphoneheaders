...
@interface MiroAnalysisAudioHelpers : NSObject {
	...
	SCD_Struct_Mi1 _currentRangeStartTime;
	SCD_Struct_Mi1 _recordingStartTime;
	SCD_Struct_Mi1 _recordingEndTime;
...
-(id)_outputVoiceRangeWithDetectionTime:(SCD_Struct_Mi1)arg1 ;
...
-(BOOL)_startProcessingWithStartTime:(SCD_Struct_Mi1)arg1 audioStreamDescription:(AudioStreamBasicDescription)arg2 numberOfSamplesPerBuffer:(unsigned)arg3 ;
...
-(void)_stopDetectingVoiceWithEndTime:(SCD_Struct_Mi1)arg1 lastVoiceRanges:(id*)arg2 ;
