...
@class NSString, IKDOMDocument, NSDictionary, ISURLOperation, NSMutableArray, NSMutableURLRequest, NSURLSessionConfiguration, NSURLSession, NSURLConnection, NSHTTPURLResponse, NSData, NSError, JSManagedValue;
