...
@class UIView, UIBarButtonItem, NSArray, UIGestureRecognizer, UIAlertController, AKSignaturesViewController_iOS, AKLineStylesViewController, AKTextAttributesViewController, AKColorPickerViewController, AKUndoViewController, AKFloatingAttributePickerViewController, NSLayoutConstraint, NSString;
...
@property (nonatomic,retain) AKUndoViewController * undoPopoverViewController;                                      //@synthesize undoPopoverViewController=_undoPopoverViewController - In the implementation block
...
-(AKUndoViewController *)undoPopoverViewController;
...
-(void)setUndoPopoverViewController:(AKUndoViewController *)arg1 ;
