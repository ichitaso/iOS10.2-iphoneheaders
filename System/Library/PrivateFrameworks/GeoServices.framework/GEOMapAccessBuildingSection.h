...
@property (nonatomic,readonly) SCD_Struct_GE26 centerCoordinate;                //@synthesize centerCoordinate=_centerCoordinate - In the implementation block
@property (nonatomic,readonly) double radius;                                   //@synthesize radius=_radius - In the implementation block
@property (readonly) unsigned long long hash; 
@property (readonly) Class superclass; 
@property (copy,readonly) NSString * description; 
@property (copy,readonly) NSString * debugDescription; 
@property (nonatomic,readonly) SCD_Struct_GE26* coordinates;                    //@synthesize coordinates=_coordinates - In the implementation block
...
-(double)baseHeight;
-(id)initWithFeature:(SCD_Struct_GE104*)arg1 sectionIndex:(unsigned long long)arg2 ;
@end
