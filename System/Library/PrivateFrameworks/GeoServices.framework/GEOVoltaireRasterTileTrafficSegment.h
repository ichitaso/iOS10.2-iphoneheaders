...
@property (nonatomic,readonly) SCD_Struct_GE100* vertices;              //@synthesize vertices=_vertices - In the implementation block
...
-(void)setVertices:(SCD_Struct_GE100*)arg1 count:(long long)arg2 ;
@end
