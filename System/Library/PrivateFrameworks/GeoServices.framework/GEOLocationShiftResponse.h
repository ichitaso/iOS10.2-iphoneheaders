...
@property (assign,nonatomic) GEOPixelPoint shiftedPixel;              //@synthesize shiftedPixel=_shiftedPixel - In the implementation block
...
-(void)setShiftedPixel:(GEOPixelPoint)arg1 ;
@end
