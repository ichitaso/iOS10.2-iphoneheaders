...
-(id)initWithMuid:(unsigned long long)arg1 locationHint:(SCD_Struct_GE26)arg2 placeNameHint:(id)arg3 resultProviderId:(int)arg4 contentProvider:(id)arg5 ;
-(id)initWithExternalBusinessID:(id)arg1 contentProvider:(id)arg2 ;
-(id)initWithMapItemToRefine:(id)arg1 coordinate:(SCD_Struct_GE26)arg2 contentProvider:(id)arg3 ;
