...
@class MusicClientContext, MusicEntityValueContext, MPAVController, MusicEntityEditableVerticalLockupView, MusicVerticalScrollingContainerViewController, UIImage, NSString, MusicMediaDetailTintInformation, UIViewController;
