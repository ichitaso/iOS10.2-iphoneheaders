...
@interface IDSDAccountSendMessageContext : NSObject {
	...
	BOOL _shouldAllowCloudDelivery;
...
@property (assign,nonatomic) BOOL shouldAllowCloudDelivery;                                   //@synthesize shouldAllowCloudDelivery=_shouldAllowCloudDelivery - In the implementation block
...
-(void)setShouldAllowCloudDelivery:(BOOL)arg1 ;
