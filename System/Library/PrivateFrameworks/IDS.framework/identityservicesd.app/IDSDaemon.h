...
+(BOOL)_commandIsSessionCommand:(long long)arg1 ;
+(id)sharedInstance;
...
-(BOOL)daemonInterface:(id)arg1 shouldGrantAccessForPID:(int)arg2 auditToken:(SCD_Struct_ID23)arg3 portName:(id)arg4 listenerConnection:(id)arg5 setupInfo:(id)arg6 setupResponse:(id*)arg7 ;
...
-(void)_ackMessageWithSequenceNumber:(unsigned)arg1 forDeviceID:(id)arg2 priority:(long long)arg3 connectionType:(long long)arg4 guid:(id)arg5 ;
...
-(BOOL)_checkIfDupeAndNoteGuid:(id)arg1 local:(BOOL)arg2 topic:(id)arg3 forceNoteGuid:(BOOL)arg4 ;
-(void)_addIncomingGUIDsWithGuid:(id)arg1 isLocal:(BOOL)arg2 hasLock:(BOOL)arg3 ;
...
-(void)continuityStartScanningForType:(long long)arg1 withData:(id)arg2 mask:(id)arg3 peers:(id)arg4 boostedScan:(BOOL)arg5 duplicates:(BOOL)arg6 messageContext:(id)arg7 ;
-(void)continuityStartScanningForType:(long long)arg1 withData:(id)arg2 mask:(id)arg3 boostedScan:(BOOL)arg4 duplicates:(BOOL)arg5 messageContext:(id)arg6 ;
