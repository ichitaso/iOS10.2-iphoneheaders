...
@property (nonatomic,retain) NSDictionary * clientStatus;                                  //@synthesize clientStatus=_clientStatus - In the implementation block
...
-(void)setClientStatus:(NSDictionary *)arg1 ;
