...
@class NSURLRequest, NSArray, NSString;
...
@property (nonatomic,retain) NSString * ticket;                                            //@synthesize ticket=_ticket - In the implementation block
