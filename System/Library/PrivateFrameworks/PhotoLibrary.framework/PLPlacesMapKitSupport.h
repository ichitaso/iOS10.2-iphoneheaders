...
-(SCD_Struct_PL20)coordinateRegionForMapRect:(SCD_Struct_PL19)arg1 ;
-(SCD_Struct_PL19)mapRectForCoordinateRegion:(SCD_Struct_PL20)arg1 ;
-(double)metersPerMapPointAtLatitude:(double)arg1 ;
-(SCD_Struct_PL19)mapRectAtCoordinate:(CLLocationCoordinate2D)arg1 radialDistance:(double)arg2 ;
