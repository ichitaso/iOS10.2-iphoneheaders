...
@property (assign,nonatomic) SCD_Struct_PV24 timeRange; 
...
-(void)setTimeRange:(SCD_Struct_PV24)arg1 ;
-(void)loadInstructionGraphNodes:(HGRef<PVRenderContext>*)arg1 ;
