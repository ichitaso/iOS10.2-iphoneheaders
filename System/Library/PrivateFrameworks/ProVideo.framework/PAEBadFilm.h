...
-(void)createDust:(int)arg1 scratches:(int)arg2 scratchColor:(double*)arg3 hair:(int)arg4 randomSeed:(int)arg5 autoRandFreq:(int)arg6 width:(int)arg7 height:(int)arg8 buffer:(char*)arg9 atTime:(/*function pointer*/void**)arg10 pixelTransform:(const PCMatrix44Tmpl<double>*)arg11 ;
@end
