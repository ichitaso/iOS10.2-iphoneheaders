...
#import <libobjc.A.dylib/CAMPreviewViewSubjectIndicatorDelegate.h>
#import <libobjc.A.dylib/CAMFacesDelegate.h>

@protocol CAMPreviewViewControllerDelegate;
@class CAMEffectsRenderer, CUCaptureController, CAMTimelapseController, CAMBurstIndicatorView, CAMFocusIndicatorView, NSDate, CAMFocusResult, CAMExposureResult, UITapGestureRecognizer, UILongPressGestureRecognizer, UIPanGestureRecognizer, CAMSubjectIndicatorView, CAMMotionController, CAMPreviewView, NSString;
...
-(void)handleTapAtPoint:(CGPoint)arg1 ;
