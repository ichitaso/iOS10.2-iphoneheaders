...
@property (assign,nonatomic) BOOL hasLastSysMode; 
@property (assign,nonatomic) int lastSysMode;                           //@synthesize lastSysMode=_lastSysMode - In the implementation block
