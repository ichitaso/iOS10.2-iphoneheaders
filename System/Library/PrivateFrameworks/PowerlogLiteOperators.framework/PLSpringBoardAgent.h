...
@class PLNSNotificationOperatorComposition, PLCFNotificationOperatorComposition, PLTimer, PLEntryNotificationOperatorComposition, PLXPCListenerOperatorComposition, PLMonotonicTimer, NSDate, NSDictionary, PLEntry;
...
@property (readonly) PLXPCListenerOperatorComposition * userNotificationRequestEvent;                                 //@synthesize userNotificationRequestEvent=_userNotificationRequestEvent - In the implementation block
@property (readonly) PLXPCListenerOperatorComposition * userNotificationTriggerEvent;                                 //@synthesize userNotificationTriggerEvent=_userNotificationTriggerEvent - In the implementation block
