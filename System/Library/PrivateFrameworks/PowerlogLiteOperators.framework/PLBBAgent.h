...
#import <libobjc.A.dylib/PLABMClientMessageDelegate.h>

@class PLBasebandLogChannel, PLEntryNotificationOperatorComposition, PLTelephonyConnection, PLABMClient, PLCFNotificationOperatorComposition, NSDate, NSMutableDictionary, NSNumber, NSString, PLBBTelephonyRegMsg, PLBBTelephonyActivityMsg, PLNSNotificationOperatorComposition, PLTimer;

@interface PLBBAgent : PLAgent <PLBasebandLogChannelDelegate, PLABMClientMessageDelegate> {
...
@property (retain) PLABMClient * abmClient;                                                             //@synthesize abmClient=_abmClient - In the implementation block
...
@property (retain) PLCFNotificationOperatorComposition * cfNotifyBBReport30s;                           //@synthesize cfNotifyBBReport30s=_cfNotifyBBReport30s - In the implementation block
@property (retain) PLCFNotificationOperatorComposition * cfNotifyBBReport;                              //@synthesize cfNotifyBBReport=_cfNotifyBBReport - In the implementation block
...
@property (retain) PLNSNotificationOperatorComposition * bbICEModelLTEMetricsNotification;              //@synthesize bbICEModelLTEMetricsNotification=_bbICEModelLTEMetricsNotification - In the implementation block
...
-(void)setAbmClient:(PLABMClient *)arg1 ;
...
-(void)setCfNotifyBBReport:(PLCFNotificationOperatorComposition *)arg1 ;
-(void)setupKICEChannelsForDebug;
-(void)setCfNotifyBBReport30s:(PLCFNotificationOperatorComposition *)arg1 ;
...
-(void)setBbICEModelLTEMetricsNotification:(PLNSNotificationOperatorComposition *)arg1 ;
