...
@class NSObject, NSMutableDictionary, NSMutableSet, NSNumber, BBDataProviderConnection, SOSContactsManager, HDProfile, NSString;
...
-(BOOL)_deleteObjectsWithTypes:(id)arg1 sourceIdentifier:(id)arg2 recursiveDeleteAuthorizationBlock:(/*^block*/id)arg3 error:(id*)arg4 ;
