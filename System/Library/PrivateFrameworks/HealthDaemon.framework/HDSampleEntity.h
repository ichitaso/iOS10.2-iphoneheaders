...
+(void)deleteSamplesWithTypes:(id)arg1 sourceIdentifier:(id)arg2 profile:(id)arg3 recursiveDeleteAuthorizationBlock:(/*^block*/id)arg4 completionHandler:(/*^block*/id)arg5 ;
...
+(id)timePeriodForSamplesOfType:(id)arg1 database:(id)arg2 matchingPredicate:(id)arg3 error:(id*)arg4 cancellationBlock:(/*^block*/id)arg5 ;
