...
@class UIView, _UIBackdropView, SiriUIAudioRoutePickerButton, SiriUIHelpButton, SiriUIContentButton, SiriUIKeyboardButton, SiriUIConfiguration, NSString;
...
-(void)showPasscodeUnlockWithStatusText:(id)arg1 completionHandler:(/*^block*/id)arg2 unlockCompletionHandler:(/*^block*/id)arg3 ;
