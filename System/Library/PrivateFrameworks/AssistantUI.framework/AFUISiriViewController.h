...
@class AFUIDelayedActionCommandCache, SiriUIConfiguration, SACarPlaySupportedOEMAppIdList, NSString, NSObject, AFUISiriSession, AFUISiriRemoteViewController, SiriUIAudioRoutePickerController, UIStatusBar, AFUIRequestOptions, NSNumber;
