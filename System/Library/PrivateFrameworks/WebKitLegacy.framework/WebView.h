...
@property (assign,nonatomic) id<WebEditingDelegate> editingDelegate; 
...
-(void)_setHostApplicationProcessIdentifier:(int)arg1 auditToken:(SCD_Struct_We55)arg2 ;
...
-(void)showCandidates:(id)arg1 forString:(id)arg2 inRect:(CGRect)arg3 forSelectedRange:(NSRange)arg4 view:(id)arg5 completionHandler:(/*^block*/id)arg6 ;
...
-(void)setEditingDelegate:(id<WebEditingDelegate>)arg1 ;
