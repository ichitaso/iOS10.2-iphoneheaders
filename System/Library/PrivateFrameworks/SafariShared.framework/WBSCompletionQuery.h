...
@property (nonatomic,copy) NSString * parsecCompletionString;                                    //@synthesize parsecCompletionString=_parsecCompletionString - In the implementation block
...
-(NSString *)parsecCompletionString;
-(void)setParsecCompletionString:(NSString *)arg1 ;
