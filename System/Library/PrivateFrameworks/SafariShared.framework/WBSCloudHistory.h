...
@protocol OS_dispatch_queue, NSObject, WBSCloudHistoryDataStore;
@class NSObject, WBSCloudHistoryConfiguration, WBSCloudHistoryThrottler, NSTimer, WBSCloudHistoryPushAgentProxy, NSMutableDictionary, NSString;
...
-(id)initWithConfiguration:(id)arg1 completionBlock:(/*^block*/id)arg2 ;
