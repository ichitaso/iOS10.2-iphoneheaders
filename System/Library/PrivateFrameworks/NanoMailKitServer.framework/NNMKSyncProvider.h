...
@class NSObject, BLTPingSubscriber, PSYSyncCoordinator, NNMKDeviceSyncRegistry, NNMKMessagesSyncServiceServer, NNMKMessageContentSyncServiceServer, NNMKAccountsSyncServiceServer, NNMKFetchesSyncServiceServer, NNMKProtectedSyncServiceServer, NNMKProtectedContentSyncServiceServer, NSMutableSet, NSMutableDictionary, NNMKProtoFetchRequest, NSDate, NSString, NSURL, NNMKPairedDeviceInfo;
...
@property (assign,nonatomic) BOOL waitingForBatchedMessagesForFetchResponse;                                         //@synthesize waitingForBatchedMessagesForFetchResponse=_waitingForBatchedMessagesForFetchResponse - In the implementation block
...
-(void)_handleNotificationPayloadAck:(/*^block*/id)arg1 forMessageId:(id)arg2 ;
