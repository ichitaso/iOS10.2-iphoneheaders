...
-(id)_inqNewGroupsWithMatchingGroupIds:(const void*)arg1 count:(long long)arg2 matchingPredicateBlock:(/*^block*/id)arg3 ;
...
-(unsigned long long)_inqGroupIdForCategory:(short)arg1 owningGroupId:(unsigned long long)arg2 contentString:(id)arg3 insertIfNeeded:(BOOL)arg4 tokenOutput:(const tokenOutput_t*)arg5 shouldUpdateOwningGroupId:(BOOL)arg6 ;
...
-(CFSetRef)_inqNewGroupIdsForDeleteOperationWithMatchingGroupIds:(const void*)arg1 count:(long long)arg2 ;
