...
@property (assign,setter=_setHiddenFaceStateChanged:,nonatomic) BOOL _hiddenFaceStateChanged;                        //@synthesize _hiddenFaceStateChanged=__hiddenFaceStateChanged - In the implementation block
