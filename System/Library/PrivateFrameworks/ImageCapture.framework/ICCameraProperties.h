...
@property (nonatomic,retain) NSObject*<OS_dispatch_queue> thumbnailFetchQ;                   //@synthesize thumbnailFetchQ=_thumbnailFetchQ - In the implementation block
@property (nonatomic,retain) NSObject*<OS_dispatch_queue> metadataFetchQ;                    //@synthesize metadataFetchQ=_metadataFetchQ - In the implementation block
@property (nonatomic,retain) NSObject*<OS_dispatch_queue> downloadQ;                         //@synthesize downloadQ=_downloadQ - In the implementation block
@property (nonatomic,retain) NSObject*<OS_dispatch_queue> generalQ;                          //@synthesize generalQ=_generalQ - In the implementation block
@property (nonatomic,retain) NSObject*<OS_dispatch_semaphore> deviceQSemaphore;              //@synthesize deviceQSemaphore=_deviceQSemaphore - In the implementation block
...
@property (assign) BOOL applePTPCapable;                                                     //@synthesize applePTPCapable=_applePTPCapable - In the implementation block
@property (retain) NSMutableArray * requestedFiles;                                          //@synthesize requestedFiles=_requestedFiles - In the implementation block
...
-(void)setRequestedFiles:(NSMutableArray *)arg1 ;
