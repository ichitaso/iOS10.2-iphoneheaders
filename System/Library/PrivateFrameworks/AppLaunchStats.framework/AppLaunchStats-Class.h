...
@property (retain) NSSet * trendCandidates;                                                   //@synthesize trendCandidates=_trendCandidates - In the implementation block
...
-(id)firstWakeApps;
-(void)setTrendCandidates:(NSSet *)arg1 ;
