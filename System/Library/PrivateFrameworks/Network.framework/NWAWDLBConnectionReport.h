...
@interface NWAWDLBConnectionReport : PBCodable <NSCopying> {
	...
	SCD_Struct_NW16* _connectionReadyTimes;
	SCD_Struct_NW14* _resumptionFailureErrors;
	SCD_Struct_NW16* _resumptionFailureTimes;
	SCD_Struct_NW16* _resumptionSuccessTimes;
