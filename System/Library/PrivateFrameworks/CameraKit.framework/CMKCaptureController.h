...
@property (setter=_setEffectsRenderer:,retain) CMKEffectsRenderer * effectsRenderer;                                                                                                   //@synthesize effectsRenderer=_effectsRenderer - In the implementation block
...
@property (setter=_setSupportedCameraModes:,nonatomic,copy) NSArray * supportedCameraModes;                                                                                            //@synthesize supportedCameraModes=_supportedCameraModes - In the implementation block
...
@property (assign,setter=_setPerformingAvalancheCapture:,nonatomic) BOOL performingAvalancheCapture;                                                                                   //@synthesize performingAvalancheCapture=_performingAvalancheCapture - In the implementation block
...
@property (assign,nonatomic,__weak) id<PLCameraControllerDelegate> delegate; 
...
-(void)setDelegate:(id<PLCameraControllerDelegate>)arg1 ;
-(void)dealloc;
-(id<PLCameraControllerDelegate>)delegate;
...
-(void)_deviceConfigurationForPanoramaOptions:(CFDictionaryRef)arg1 captureDevice:(id)arg2 deviceFormat:(id*)arg3 minFrameDuration:(SCD_Struct_CM13*)arg4 maxFrameDuration:(SCD_Struct_CM13*)arg5 ;
