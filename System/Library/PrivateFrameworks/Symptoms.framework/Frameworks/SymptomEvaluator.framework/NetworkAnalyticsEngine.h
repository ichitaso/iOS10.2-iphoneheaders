...
-(BOOL)_writeJournalRecord:(SCD_Struct_Ne14*)arg1 fromCellFingerprint:(BOOL)arg2 key:(const char*)arg3 atLOI:(long long)arg4 ofKind:(id)arg5 lqm:(int)arg6 isFaulty:(unsigned)arg7 ;
