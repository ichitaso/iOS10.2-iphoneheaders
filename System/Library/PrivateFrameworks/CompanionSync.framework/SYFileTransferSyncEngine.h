...
@class SYStartSyncSession, NSURL, _SYOutputStreamer, _SYInputStreamer, IDSService, NSObject, SYDevice, NSMutableIndexSet, NSMutableArray, NSMutableSet, NSDictionary, NSString;
