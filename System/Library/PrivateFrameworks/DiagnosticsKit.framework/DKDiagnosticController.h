...
@class NSDictionary, DKMutableResult, DKDiagnosticContext, NSLock, NSString;

@interface DKDiagnosticController : NSObject <DKDiagnostic_Internal, DKDiagnostic, NSExtensionRequestHandling> {
