...
@property (assign,nonatomic) unsigned long long numberOfAssetPlaylistItemsNeedingDownload;                                    //@synthesize numberOfAssetPlaylistItemsNeedingDownload=_numberOfAssetPlaylistItemsNeedingDownload - In the implementation block
