...
@class NSUUID, HMDCameraSessionID, NSObject, HMDAccessory, NSDictionary, HMDSnapshotFile, HMDSnapshotRequestHandler, HMDCameraResidentMessageHandler, HMDCameraSnapshotMetrics, NSString;
...
-(void)_sendRequestWithTierType:(unsigned long long)arg1 toResident:(/*^block*/id)arg2 ;
