...
@class HMDLocalStreamSession, HMDCameraMediaConfigGenerator, HMDCameraSupportedConfigurationCache, NSString, HMDCameraStreamMetrics;
...
@property (nonatomic,retain) HMDLocalStreamSession * streamSession;                                    //@synthesize streamSession=_streamSession - In the implementation block
...
-(void)setStreamSession:(HMDLocalStreamSession *)arg1 ;
-(void)_stopCurrentStreamSession:(id)arg1 ;
-(HMDLocalStreamSession *)streamSession;
