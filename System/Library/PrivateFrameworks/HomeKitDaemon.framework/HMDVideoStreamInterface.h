...
@class HMDVideoStreamReconfigure, AVCVideoStream, NSObject, HAPOSTransaction, NSNumber, NSString;
...
@property (nonatomic,retain) HAPOSTransaction * snapshotDataTrasaction;                         //@synthesize snapshotDataTrasaction=_snapshotDataTrasaction - In the implementation block
...
-(void)setSnapshotDataTrasaction:(HAPOSTransaction *)arg1 ;
