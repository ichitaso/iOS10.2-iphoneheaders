...
@class NSMutableArray, NSArray, NSMutableDictionary, NSMapTable, NSString;
...
@property (assign,nonatomic,__weak) id<NUIContainerStackViewDelegate> delegate;                                            //@synthesize delegate=_delegate - In the implementation block
...
-(id<NUIContainerStackViewDelegate>)delegate;
...
-(void)__calculateExtendedDistributiontPositionsForViews:(id)arg1 withBounds:(CGRect)arg2 totalSize:(CGSize)arg3 intoRects:(CGRect*)arg4 ;
@end
