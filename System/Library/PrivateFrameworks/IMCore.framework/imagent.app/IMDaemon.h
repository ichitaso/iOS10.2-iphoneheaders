...
-(void)debugUpdateGroupParticipantversion:(unsigned long long)arg1 chatIdentifier:(id)arg2 messageContext:(id)arg3 ;
...
-(void)downloadStickerPackWithGUID:(id)arg1 isIncomingMessage:(BOOL)arg2 ignoreCache:(BOOL)arg3 messageContext:(id)arg4 ;
...
-(void)markAsSpamForIDs:(id)arg1 style:(unsigned char)arg2 onServices:(id)arg3 chatID:(id)arg4 queryID:(id)arg5 autoReport:(BOOL)arg6 messageContext:(id)arg7 ;
