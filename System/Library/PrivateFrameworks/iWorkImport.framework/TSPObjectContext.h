...
-(id)initWithURL:(id)arg1 delegate:(id)arg2 registry:(id)arg3 documentResourceManager:(id)arg4 mode:(unsigned)arg5 passphrase:(id)arg6 skipDocumentUpgrade:(BOOL)arg7 error:(id*)arg8 ;
