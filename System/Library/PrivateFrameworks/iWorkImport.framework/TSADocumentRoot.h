...
@class NSDictionary, NSMutableDictionary, TSPLazyReference, NSMutableSet, NSString, TSCECalculationEngine, TSAFunctionBrowserState, TSTCustomFormatList, TSKCustomFormatList, TSAShortcutController, NSObject, SFUCryptoKey, NSArray, TSKViewState, NSSet;
...
-(void)p_iterateDrawables:(id)arg1 removeDrawableCommentBlock:(/*^block*/id)arg2 removeTextCommentsBlock:(/*^block*/id)arg3 removeCellCommentBlock:(/*^block*/id)arg4 ;
