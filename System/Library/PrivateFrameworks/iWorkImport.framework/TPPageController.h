...
@class TPDocumentRoot, TSWPLayoutManager, TPSearchCanvasDelegate, TPFootnoteLayoutController, NSMutableArray, TPPageLayoutState, NSDate, TSUMutablePointerSet, TSWPLayoutMetricsCache, NSString;
...
@interface TPPageController : NSObject <TPPageLayoutInfoProvider, TSWPLayoutOwner, TPLayoutStateConsumer, TPLayoutStateProvider> {
	...
	Ai _backgroundLayoutEnabled;
	Ai _backgroundLayoutSuspendCount;
	Ai _isScrolling;
	Ai _isZooming;
...
-(void)p_layoutNextPageForLayoutController:(id)arg1 dirtyRange:(const TSWPDirtyRangeVector*)arg2 ;
-(void)p_didLayout;
...
-(void)p_syncFromNextPageWithDirtyRanges:(const TSWPDirtyRangeVector*)arg1 pageTextRange:(const NSRange*)arg2 ;
