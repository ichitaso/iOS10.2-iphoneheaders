...
@class NSString, NSMutableArray, IMHandle, IMAVChatParticipant, NSMutableDictionary, NSNumber, NSDate, NSDictionary, IMTimingCollection, NSObject, NSData, NSError, IMPair, NSTimer, NSArray, IMAccount;
