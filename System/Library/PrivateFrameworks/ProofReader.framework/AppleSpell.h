...
-(unsigned)_tokenIDForString:(id)arg1 languageModel:(void*)arg2 language:(id)arg3 createIfAbsent:(BOOL)arg4 terminatorTokenID:(unsigned)arg5 ;
...
-(void)_addLanguageModelCompletionsForPrefix:(id)arg1 languageModel:(void*)arg2 language:(id)arg3 connection:(PR_DB_IO*)arg4 sender:(id)arg5 encoding:(unsigned)arg6 capitalized:(BOOL)arg7 candidates:(id)arg8 ;
...
-(BOOL)validateWord:(id)arg1 inLexiconForLanguage:(id)arg2 requiredMetaFlags:(unsigned)arg3 prohibitedMetaFlags:(unsigned)arg4 ;
...
-(unsigned long long)numberOfTurkishSuffixPointsInBuffer:(char*)arg1 length:(unsigned long long)arg2 maxSuffixPoints:(unsigned long long)arg3 suffixPoints:(SCD_Struct_Ap2*)arg4 ;
...
-(BOOL)_findMatchingRangesForRange:(NSRange)arg1 inString:(id)arg2 keyEventArray:(id)arg3 endingAtIndex:(unsigned long long)arg4 matchingStringRange:(NSRange*)arg5 correctableStringRange:(NSRange*)arg6 matchingKeyEventRange:(NSRange*)arg7 lastMisspelledKeyEventIndex:(unsigned long long*)arg8 previousBackspaceCount:(unsigned long long*)arg9 ;
...
-(void)addSpaceCorrectionForString:(id)arg1 range:(NSRange)arg2 inString:(id)arg3 offset:(unsigned long long)arg4 tagger:(id)arg5 language:(id)arg6 connection:(PR_DB_IO*)arg7 toGuesses:(id)arg8 ;
-(BOOL)findMatchingRangesForRange:(NSRange)arg1 inString:(id)arg2 keyEventArray:(id)arg3 selectedRangeValue:(id)arg4 matchingStringRange:(NSRange*)arg5 correctableStringRange:(NSRange*)arg6 matchingKeyEventRange:(NSRange*)arg7 lastMisspelledKeyEventIndex:(unsigned long long*)arg8 previousBackspaceCount:(unsigned long long*)arg9 ;
