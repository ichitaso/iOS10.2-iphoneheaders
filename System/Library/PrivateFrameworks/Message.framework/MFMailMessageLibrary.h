...
@protocol OS_dispatch_queue, MFMailboxPathProvider, MFMailMessageLibraryDelegate, OS_dispatch_source, OS_os_activity;
@class MFSQLiteConnectionPool, MFWeakObjectCache, NSObject, MFMailMessageLibraryMigrator, NSString, MFDbJournal, NSMutableSet, MFWeakSet, MFLibrarySearchableIndex;
