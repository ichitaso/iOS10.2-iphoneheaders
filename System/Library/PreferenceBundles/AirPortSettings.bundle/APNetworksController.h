...
@interface APNetworksController : PSListController <AirPortAssistantControllerDelegate> {
	...
	BOOL _pushToAllowDataUsage;

}

@property (assign,nonatomic) BOOL pushToAllowDataUsage;              //@synthesize pushToAllowDataUsage=_pushToAllowDataUsage - In the implementation block
-(id)init;
-(void)dealloc;
...
-(BOOL)pushToAllowDataUsage;
-(void)setPushToAllowDataUsage:(BOOL)arg1 ;
-(id)specifiers;
@end
