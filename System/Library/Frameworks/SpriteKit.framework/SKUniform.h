...
@property (assign,nonatomic) SCD_Struct_SK53 matrixFloat2x2Value; 
@property (assign,nonatomic) SCD_Struct_SK54 matrixFloat3x3Value; 
...
+(id)uniformWithName:(id)arg1 ;
+(id)uniformWithName:(id)arg1 matrixFloat2x2:(SCD_Struct_SK53)arg2 ;
+(id)uniformWithName:(id)arg1 matrixFloat3x3:(SCD_Struct_SK54)arg2 ;
...
-(SCD_Struct_SK53)matrixFloat2x2Value;
-(SCD_Struct_SK54)matrixFloat3x3Value;
-(SCD_Struct_SK5)matrixFloat4x4Value;
-(void)set_seed:(unsigned long long)arg1 ;
-(void)setTextureValue:(SKTexture *)arg1 ;
-(void)setMatrixFloat2x2Value:(SCD_Struct_SK53)arg1 ;
-(void)setMatrixFloat3x3Value:(SCD_Struct_SK54)arg1 ;
...
-(id)initWithName:(id)arg1 ;
-(id)initWithName:(id)arg1 ;
-(id)initWithName:(id)arg1 matrixFloat2x2:(SCD_Struct_SK53)arg2 ;
-(id)initWithName:(id)arg1 matrixFloat3x3:(SCD_Struct_SK54)arg2 ;
