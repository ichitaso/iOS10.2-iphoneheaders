...
-(id)_gkMapAccountsWithBlock:(/*^block*/id)arg1 ;
-(id)_gkAllCredentialsForEnvironment:(long long)arg1 ;
-(id)_gkCredentialForUsername:(id)arg1 environment:(long long)arg2 ;
-(void)_gkSetScope:(unsigned)arg1 forCredential:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
-(id)_gkAllCredentials;
-(id)_gkPrimaryCredentialForEnvironment:(long long)arg1 ;
-(void)_gkSaveCredential:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
-(void)_gkDeleteCredential:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
