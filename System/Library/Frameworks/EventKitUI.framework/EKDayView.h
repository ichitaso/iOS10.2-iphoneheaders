...
@class UIImageView, UIView, NSArray, NSDate, EKDayAllDayView, EKDayViewContent, EKDayTimeView, UIScrollView, NSTimer, UIPinchGestureRecognizer, UITapGestureRecognizer, NSDateComponents, NSCalendar, EKEvent, UIColor, UIVisualEffect, NSString;
