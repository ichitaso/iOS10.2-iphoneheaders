...
@class UIView, UIScrollView, EKDayView, EKDayOccurrenceView, EKDayViewWithGutters, NSDateComponents, CalendarOccurrencesCollection, EKEventGestureController, ScrollSpringFactory, NSCalendar, EKEventEditViewController, NSTimer, NSString;
