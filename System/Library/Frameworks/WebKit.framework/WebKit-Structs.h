...
typedef struct MessageSender* MessageSenderRef;
...
typedef struct RefPtr<WebKit::NetworkSession> {
	NetworkSession m_ptr;
} RefPtr<WebKit::NetworkSession>;
...
typedef struct BlockPtr<void (PKPaymentAuthorizationStatus)> {
	/*^block*/id m_block;
} BlockPtr<void (PKPaymentAuthorizationStatus)>;

typedef struct BlockPtr<void (NSArray *)> {
	/*^block*/id m_block;
} BlockPtr<void (NSArray *)>;

typedef struct BlockPtr<void (PKPaymentAuthorizationStatus, NSArray *)> {
	/*^block*/id m_block;
} BlockPtr<void (PKPaymentAuthorizationStatus, NSArray *)>;

typedef struct BlockPtr<void (PKPaymentAuthorizationStatus, NSArray *, NSArray *)> {
	/*^block*/id m_block;
} BlockPtr<void (PKPaymentAuthorizationStatus, NSArray *, NSArray *)>;
