...
typedef union {
	SCD_Struct_NS33 _singleRange;
	SCD_Struct_NS32 _multipleRanges;
} SCD_Union_NS34;
...
typedef struct {
	SCD_Struct_NS60 field1;
	SCD_Struct_NS60 field2;
} SCD_Struct_NS64;
...
typedef union {
	SCD_Struct_NS80 extern_data;
	SCD_Struct_NS79 inline_slab;
