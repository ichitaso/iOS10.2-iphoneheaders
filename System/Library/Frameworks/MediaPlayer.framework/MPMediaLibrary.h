...
@class NSObject, NSArray, QueryCriteriaResultsCache, NSMutableDictionary, NSMutableArray, NSPointerArray, NSURL, NSString, NSDate;
...
@property (nonatomic,readonly) shared_ptr<mlcore::Library>* _MediaLibrary_coreLibrary; 
