...
@class MPAVController, UINavigationBar, MPAVItem, MPDetailSlider, MPKnockoutButton, UIStatusBar, UIButton, UIActivityIndicatorView, UILabel, MPVolumeSlider, UIView, MPAudioAndSubtitlesController, NSLayoutConstraint, NSArray, UIViewController, _UIBackdropView, NSString;
