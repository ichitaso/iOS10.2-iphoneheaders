...
@class CNContactStoreSnapshot, NSDictionary, NSObject, CNContactFormatter, CNContactStoreFilter, CNContactStore, NSArray, CNContact, NSString, CNiOSAddressBook, CNContactFilter;
