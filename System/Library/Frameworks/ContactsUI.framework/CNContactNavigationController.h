...
@class CNContactListViewController, CNContactStyle, CNContactStore, CNContactViewController, CNAccountsAndGroupsDataSource, CNContactStoreDataSource, UIKeyCommand, NSString;
