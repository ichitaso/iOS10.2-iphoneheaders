...
@class NSString, UITableView, NSArray, NSMutableArray, CNContactViewController, ABPersonViewControllerHelper, ABPersonTableViewDataSource, ABPersonTableViewActionsDelegate, ABUIPerson, ABPersonTableViewSharingDelegate, UIView, ABContactViewController, UIFont, UIImage;
