...
@class _UICascadingTextStorage, UIImage, UIView, UITextInputTraits, _UIFullFontSize, UIButton, UITextFieldBorderView, UITextFieldBackgroundView, _UIFloatingContentView, UIVisualEffectView, _UIDetachedFieldEditorBackgroundView, UITextFieldLabel, UIImageView, UILabel, NSAttributedString, UITextInteractionAssistant, UITapGestureRecognizer, UISystemInputViewController, UITextFieldAtomBackgroundView, CUICatalog, CUIStyleEffectConfiguration, NSLayoutConstraint, _UIBaselineLayoutStrut, UIColor, NSString, UIFont, MPUTextContainerContentSizeUpdater, NSDictionary, NSIndexSet, UIInputContextHistory, UITextRange, UITextPosition;

@interface UITextField : UIControl <MPUAutoupdatingTextContainer, ABText, UIKeyboardInput, _UILayoutBaselineUpdating, _UIFloatingContentViewDelegate, UIGestureRecognizerDelegate, UIKeyInputPrivate, UITextInputTraits_Private, UIPopoverControllerDelegate, UITextInput, NSCoding, UIContentSizeCategoryAdjusting> {
