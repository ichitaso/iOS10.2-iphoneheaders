...
@interface UIKBHandwritingView : UIKBKeyView <UIGestureRecognizerDelegate> {
	...
	SCD_Struct_UI60 _previousPoint;
...
@property (assign,nonatomic) SCD_Struct_UI71 previousPoint;                                      //@synthesize previousPoint=_previousPoint - In the implementation block
...
-(void)setPreviousPoint:(SCD_Struct_UI71)arg1 ;
-(BOOL)initialPointPosted;
-(SCD_Struct_UI71)previousPoint;
