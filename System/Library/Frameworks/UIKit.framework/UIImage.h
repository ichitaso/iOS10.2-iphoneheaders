...
@class UITraitCollection, UIImageAsset, NSString, NSURL, CIImage, NSArray, UIGraphicsImageRendererFormat;
...
+(CGSize)nc_loadAnimatedImageGettingSizeForFileURL:(id)arg1 withCompletionHandler:(/*^block*/id)arg2 ;
+(id)nc_animatedImageWithImageSource:(CGImageSourceRef)arg1 ;
...
-(id)px_imageByCroppingRect:(CGRect)arg1 pixelTargetSize:(CGSize)arg2 round:(BOOL)arg3 ;
...
-(SCD_Struct_UI18)bl_pixelAtX:(int)arg1 y:(int)arg2 sampleSize:(float)arg3 ;
-(float)bl_lumaAtX:(int)arg1 y:(int)arg2 sampleSize:(float)arg3 ;
-(SCD_Struct_UI18)bl_pixelAtX:(int)arg1 y:(int)arg2 ;
...
-(CGSize)size;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI20)arg1 inRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
...
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI22)arg1 inRect:(CGRect)arg2 fraction:(double)arg3 ;
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI22)arg1 inRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
...
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI20)arg1 inRect:(CGRect)arg2 fraction:(double)arg3 ;
...
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI22)arg1 inRect:(CGRect)arg2 ;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI20)arg1 inRect:(CGRect)arg2 ;
