...
@interface UIStatusBar : _UIScrollsToTopInitiatorView <UIStatusBarServerClient, UIStatusBarStateObserver> {
	...
	SCD_Struct_UI80* _localDataOverrides;
	UIColor* _tintColor;
...
+(void)getData:(SCD_Struct_UI77*)arg1 forRequestedData:(const SCD_Struct_UI77*)arg2 withOverrides:(const SCD_Struct_UI80*)arg3 ;
...
-(void)setLocalDataOverrides:(SCD_Struct_UI80*)arg1 ;
-(CGRect)currentFrame;
-(long long)_requestedStyle;
