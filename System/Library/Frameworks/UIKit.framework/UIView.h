...
-(BOOL)wg_supportsBottomCornerRadiusGivenRootView:(id)arg1 withCornerRadius:(double)arg2 supportedCorners:(unsigned*)arg3 ;
...
-(void)ax_setContentHuggingAndCompressionResistance:(SCD_Struct_UI28)arg1 ;
