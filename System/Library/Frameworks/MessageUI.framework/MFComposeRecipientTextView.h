...
@class _MFAtomTextView, UITextView, UIColor, UIView, NSMutableArray, NSMutableDictionary, NSTimer, NSArray, NSUndoManager, UIFont, UIButton, _MFAtomTextAttachment, NSString;
