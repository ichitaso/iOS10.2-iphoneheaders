...
@interface NSDate : NSObject <HFPropertyListConvertible, FCKeyValueStoreCoding, PQLValuable, CKRecordValue, NSCopying, NSSecureCoding>
...
-(void)nss_gregorianDescriptionWithFlags:(long long)arg1 completion:(/*^block*/id)arg2 ;
