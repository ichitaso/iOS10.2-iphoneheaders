...
-(id)_messageReplayDictionaryWithService:(id)arg1 account:(id)arg2 incomingTopLevelMessage:(id)arg3 fromID:(id)arg4 ;
-(id)_messageReplayDictionaryWithService:(id)arg1 account:(id)arg2 incomingData:(id)arg3 fromID:(id)arg4 ;
