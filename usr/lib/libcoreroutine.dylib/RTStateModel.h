...
@class NSArray, NSObject, RTStateModelOneVisit, NSMutableDictionary, RTStateModelEarliestLatestEl;
...
-(void)sequentialClusterIdentificationWithHandler:(/*^block*/id)arg1 ;
...
-(void)processRawLocations:(id)arg1 handler:(/*^block*/id)arg2 ;
...
-(void)submitVisitIncidents:(id)arg1 withCompletionHandler:(/*^block*/id)arg2 ;
