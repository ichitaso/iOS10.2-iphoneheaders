...
@interface AWDNetworkServiceProxyRequestStatistics : PBCodable <NSCopying> {
	...
	SCD_Struct_AW20* _directConnectionFirstByteBuckets;
	SCD_Struct_AW20* _directConnectionLastByteBuckets;
	SCD_Struct_AW20* _firstByteBuckets;
	SCD_Struct_AW20* _lastByteBuckets;
	SCD_Struct_AW20* _udpRttBuckets;
