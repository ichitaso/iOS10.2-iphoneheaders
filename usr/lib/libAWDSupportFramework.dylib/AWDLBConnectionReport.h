...
@interface AWDLBConnectionReport : PBCodable <NSCopying> {
	...
	SCD_Struct_AW22* _connectionReadyTimes;
	SCD_Struct_AW12* _resumptionFailureErrors;
	SCD_Struct_AW22* _resumptionFailureTimes;
	SCD_Struct_AW22* _resumptionSuccessTimes;
