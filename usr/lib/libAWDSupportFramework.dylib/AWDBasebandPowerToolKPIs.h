...
@interface AWDBasebandPowerToolKPIs : PBCodable <NSCopying> {
	...
	SCD_Struct_AW12* _armUtilityPDFs;
	SCD_Struct_AW12* _causeCodeBackgroundActivityARMUtilitys;
	SCD_Struct_AW12* _causeCodeBackgroundActivityDurations;
	SCD_Struct_AW12* _causeCodeCumulativeARMUtilitys;
	SCD_Struct_AW12* _causeCodeCumulativeDurations;
	SCD_Struct_AW12* _causeCodeMarginalCoverageARMUtilitys;
	SCD_Struct_AW12* _causeCodeMarginalCoverageDurations;
	SCD_Struct_AW12* _causeCodeOOSARMUtilitys;
	SCD_Struct_AW12* _causeCodeOOSDurations;
	SCD_Struct_AW12* _causeCodeRACHFailARMUtilitys;
	SCD_Struct_AW12* _causeCodeRACHFailDurations;
	SCD_Struct_AW12* _causeCodeStruckInDCHARMUtilitys;
	SCD_Struct_AW12* _causeCodeStruckInDCHDurations;
	SCD_Struct_AW12* _causeCodeTcXONotShuttingARMUtilitys;
	SCD_Struct_AW12* _causeCodeTcXONotShuttingDurations;
	SCD_Struct_AW12* _causeCodeUnknownARMUtilitys;
	SCD_Struct_AW12* _causeCodeUnknownDurations;
